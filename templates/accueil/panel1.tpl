    ...
    <div id="collapseOne" class="panel-collapse collapse in">
        ...
        <div class="panel-body">
            ...
            <div class="col-md-9 col-xs-12">
                    ...
                    <form autocomplete="off" role="form" class="form-vertical" method="POST" id="loginParents" action="login.php" id="formLogin">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                ...
                                placeholder="Nom d'utilisateur"
                                class="pop"
                                data-content="Le nom d'utilisateur que vous avez choisi, y compris les <span style='color:red'>4 chiffres</span> du matricule de l'élève. "
                                data-html="true"
                                data-placement="top">
                        </div>  <!-- form-group -->
                        ...
                        <div class="form-group">
                            ...
                            <input name="mdp"
                                ...
                                placeholder="Mot de passe"
                                class="pop"
                                data-content="Le mot de passe que vous avez choisi"
                                data-html="true"
                                data-placement="top">
                        </div>  <!-- form-group -->
                ...
                <div class="info">
                        <p><i class="fa fa-info-circle fa-lg" style="color:#55f"></i> Les élèves doivent "inviter" leurs parents pour leur ouvrir un accès à l'application. Chaque élève peut "inviter" jusqu'à 2 parents ayant chacun un nom d'utilisateur et un mot de passe personnel.<br>
                        Voir le menu "J'invite mes parents" dans la plate-forme "élèves".</p>
                    </div>
                    </fieldset>
                </form>
