...
<p>Ce {$jour} {$date} à {$heure}, quelqu'un (sans doute vous) à l'adresse IP {$identiteReseau.ip} ({$identiteReseau.hostname}) a demandé le changement de mot passe pour l'utilisateur <strong>{$identite.userName}</strong>.</p>
...
{textformat wrap=40}
{include file="templates/disclaimer.tpl"}
{/textformat}
